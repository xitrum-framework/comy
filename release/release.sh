...
echo java -cp ../lib/log4j-1.2.14.jar:../lib/mongo-java-driver-2.0.jar:../lib/netty-3.2.1.Final.jar:../lib/scala-library-$SCALA_VERSION.jar:../lib/slf4j-api-1.5.10.jar:../lib/slf4j-log4j12-1.5.6.jar:../lib/comy_$SCALA_VERSION-$COMY_VERSION.jar -server -Xms2000m -Xmx6000m comy.main.Http config.properties >> target/comy-$COMY_VERSION/bin/http.sh
chmod +x target/comy-$COMY_VERSION/bin/http.sh
echo "#!/bin/sh\n" > target/comy-$COMY_VERSION/bin/gc.sh
echo java -cp ../lib/log4j-1.2.14.jar:../lib/mongo-java-driver-2.0.jar:../lib/netty-3.2.1.Final.jar:../lib/scala-library-$SCALA_VERSION.jar:../lib/slf4j-api-1.5.10.jar:../lib/slf4j-log4j12-1.5.6.jar:../lib/comy_$SCALA_VERSION-$COMY_VERSION.jar comy.main.GC config.properties >> target/comy-$COMY_VERSION/bin/gc.sh
